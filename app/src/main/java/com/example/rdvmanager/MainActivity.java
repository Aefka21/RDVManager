...
public class MainActivity extends AppCompatActivity {
    ...
    public void chargeData(){
        final String[] from = new String[]{DatabaseHelper._ID, DatabaseHelper.TITLE, DatabaseHelper.PERSON, DatabaseHelper.PHONE};
        final int[] to = new int[]{R.id.idRDV, R.id.Title, R.id.Person, R.id.Phone};
